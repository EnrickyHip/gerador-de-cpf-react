export const FormContent = ({cpfMessage, cpfInput, handleValidate, handleGenerate, typeInput}) => ( 
  //*essas props são enviadas no Home component, e elas funcionam aqui mesmo esse componente FormContetn tendo sido chamado no HomeMain
